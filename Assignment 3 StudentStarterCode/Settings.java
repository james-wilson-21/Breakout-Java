...
public class Settings {
	...
	public static final Color PLAYER_COLOUR = Color.PINK;		// Colour changes for maintenance
	public static final Color PADDLE_COLOUR = Color.CYAN;		// Colour changes for maintenance
